            ...
            for (var elemIndex in arrElements) {
                if (arrElements[elemIndex].id) {
                    ...
                    if (sourceField){
                        ...
                        if(arrElements[elemIndex].id == "shipping:region") {
                            //jQuery('#shipping:region option[value="'+sourceField.value+'"]').attr('selected','selected');
                            jQuery('select[data-handle="region_shipping"]').trigger('change');
                        }
                    }
                }
            }
            //$('shipping:country_id').value = $('billing:country_id').value;
            //this is my own opcheck
