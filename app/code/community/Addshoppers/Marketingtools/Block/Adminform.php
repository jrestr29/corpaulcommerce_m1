 ...
 * 
 * */
class Addshoppers_Marketingtools_Block_Adminform extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    protected $storeCode;
                ...
                <form id="edit_form" name="edit_form" method="post" action="{$url}">
                    ...
                    <fieldset id="my-fieldset">
                        <table cellspacing="0" class="form-list">
                            ...
                            <tr>
                                <td class="label">{$this->__('API Secret') } </td>
                                <td class="input-ele">
                                    <input class="input-text" name="config[api_secret]" size="40" maxlength="32" value="{$apiSecret}"/>
                                </td>
                            </tr>
                            <tr>
                                <td></td>
...
HTML;
    ...
    <div  class="entry-edit" style="width: 63%; float: right">
        <h4 class="icon-head head-edit-form fieldset-legend">{$this->__('About AddShoppers') }</h4>
        <div class="feeds">
            <img src="{$this->getSkinUrl('addshoppers_marketingtools/feeds.png') }">
        </div>
        <div>
            <div class="big-black">
...
HTML;
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $this->config = new Addshoppers_Marketingtools_Helper_Config($this->storeCode);
