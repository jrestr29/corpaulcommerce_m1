 ...
 * 
 * */
class Addshoppers_Marketingtools_Adminhtml_AdminformController extends Mage_Adminhtml_Controller_Action
{
    /**
     * View form action
     */
...
//        return json_decode($result, true);
    ...
    public function registerAction()
    {
        ...
        $config = new Addshoppers_Marketingtools_Helper_Config($params['store']);
        ...
        if(($return['result'] == -1))
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::LOGIN_EXISTS;
        }
        elseif($return['result'] == 0)
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::NOT_CREATED;
        }
        elseif($return['result'] == 2)
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::PASSWORD_TOO_SHORT;
        }
        elseif($return['result'] == 8)
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::PASSWORD_WRONG;
        }
        elseif(($return['result'] == 1) || (isset($params['register']['register'])))
        {
            ...
            $message = Addshoppers_Marketingtools_Block_Adminform::CREATED;
        }
        else
        {
    ...
    public function settingsAction()
    {
        ...
        $config->setApiSecret($params['config']['api_secret']);
    ...
    public function loginAction()
    {
        ...
        if($return['result'] == 17)
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::DOMAIN_BANNED;
        }
        elseif($return['result'] == 11)
        {
            $message = Addshoppers_Marketingtools_Block_Adminform::WRONG_CREDENTIAL;
        }
        elseif(($return['result'] == 1) || ($return['result'] == 15) || ($return['result'] == 10))
        {
            ...
            if($return['result'] == 10)
            {
                if((isset($params['login']['login'])) && (isset($params['login']['password'])))
                {
                    ...
                    if(!isset($return['api_secret']))
                    {
                        $return['api_secret'] = $config->getApiSecret();
                    }
                    ...
                    $config->setShopId($return['shopid']);
                    $config->setApiKey($return['api_key']);
                    $config->setApiSecret($return['api_secret']);
                    $config->setUrl($this->shopUrl);
    ...
    {
        Mage::register('addshoppers_marketingtools', Mage::getModel('addshoppers_marketingtools/form'));
    }
