...
namespace MagicToolbox\MagicZoom\Block\Product\Renderer\Listing;
...
class Configurable extends \Magento\Swatches\Block\Product\Renderer\Listing\Configurable
{
     ...
     */
    const MAGICTOOLBOX_MEDIA_CALLBACK_ACTION = 'magiczoom/ajax/media';

    /**
     * @var \MagicToolbox\MagicZoom\Helper\ConfigurableData
     */
    protected $helper;
     ...
     * @param \MagicToolbox\MagicZoom\Helper\ConfigurableData $helper
    ...
    public function __construct(
        ...
        \MagicToolbox\MagicZoom\Helper\ConfigurableData $helper,
    ...
    protected function _getAdditionalConfig()
    {
        ...
        if ($data && $data['current-renderer'] == 'configurable.magiczoom') {
            $config['magictoolbox'] = [
