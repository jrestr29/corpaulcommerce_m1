...
class Gallery extends \Magento\Catalog\Block\Product\View\Gallery
{
     ...
     * @param \MagicToolbox\MagicZoom\Helper\Image $imageHelper
     * @param array $data
     */
    public function __construct(
        ...
        \MagicToolbox\MagicZoom\Helper\Image $imageHelper,
        array $data = []
    ) {
    ...
    public function renderGalleryHtml($product = null, $isAssociatedProduct = false, $data = [])
    {
        ...
        if (!isset($this->renderedGalleryHtml[$id])) {
            ...
            ob_start();
            try {
                include ($this->getTemplateFile('MagicToolbox_MagicZoom::product/view/layouts/'.$layout.'.phtml'));
