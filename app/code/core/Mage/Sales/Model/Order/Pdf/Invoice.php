...
class Mage_Sales_Model_Order_Pdf_Invoice extends Mage_Sales_Model_Order_Pdf_Abstract
{
    ...
    protected function insertOrder(&$page, $obj, $putOrderId = true)
    {
        ...
        $page->setLineColor(new Zend_Pdf_Color_GrayScale(0.5));
        $page->setLineWidth(0.5);
        $page->drawRectangle(25, $top+25, 570, $top +5);
        //$this->y -= 10;
        $page->setFillColor(new Zend_Pdf_Color_RGB(0, 0, 0));

        $page->drawText('Empresa que factura', 260, ($top+12), 'UTF-8');
        ...
        $page->setLineColor(new Zend_Pdf_Color_GrayScale(0.5));
        $page->setLineWidth(0.5);
        $page->drawRectangle(25, $top+8, 570, $top-95);
        $this->y -= 10;
        $page->setFillColor(new Zend_Pdf_Color_RGB(0, 0, 0));
        ...
        $top -= 12;
        $page->drawText('890.981.683-8',275,$top,'UTF-8');
        $top -= 12;
        $page->drawText('CALLE 9CSUR 50FF - 67 MEDELLIN',220,$top,'UTF-8');
        $top -= 12;
