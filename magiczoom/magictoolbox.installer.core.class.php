<?php
    ...
    class MagicToolboxCoreInstallerClass {
        ...
        function sendStat($mode = '') {
            ...
            if('working' == 'v4.14.5' || 'working' == 'v5.2.1') {
                return;
            }
            ...
            $path = "api/stat/?action={$mode}&tool_name=magiczoom&license=trial&tool_version=v5.2.1&module_version=v4.14.5&platform_name=magento&platform_version={$platformVersion}&url={$url}";
